...
export const SOCIAL_PLATFORMS = [
  ...
  { id: 'facebook', label: 'Facebook', icon: <Facebook className="w-4 h-4 text-muted-foreground" /> },
  { id: 'linkedin', label: 'LinkedIn', icon: <Linkedin className="w-4 h-4 text-muted-foreground" /> },
  { id: 'instagram', label: 'Instagram', icon: <Instagram className="w-4 h-4 text-muted-foreground" /> },
  ...
  { id: 'youtube', label: 'YouTube', icon: <Youtube className="w-4 h-4 text-muted-foreground" /> },
  { id: 'website', label: 'Website', icon: <Globe className="w-4 h-4 text-muted-foreground" /> },
  { id: 'custom', label: 'Custom', icon: <Globe className="w-4 h-4 text-muted-foreground" /> }
];
...
export function LinkForm({
  ...
  const [isFormVisible, setIsFormVisible] = useState(!!initialValues);
  ...
  // Function to render selected platform icon
  const renderSelectedPlatformIcon = () => {
