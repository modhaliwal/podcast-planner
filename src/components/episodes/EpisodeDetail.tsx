  ...
  return (
    <div className={cn("space-y-4 sm:space-y-6", className)}>
      ...
      <div className="flex flex-col space-y-4 sm:space-y-6">
          ...
          <CardContent className="p-4 sm:p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="md:col-span-1 order-1 md:order-2">
                {episode.coverArt ? (
                  <div className="rounded-md overflow-hidden border border-border shadow-sm max-w-[180px] sm:max-w-[240px] mx-auto md:ml-auto md:mr-0">
                    <AspectRatio ratio={1}>
                      <img 
                  ...
                  <div className="rounded-md overflow-hidden border border-border shadow-sm bg-muted flex items-center justify-center max-w-[180px] sm:max-w-[240px] mx-auto md:ml-auto md:mr-0">
                    <AspectRatio ratio={1}>
        ...
        <Card>
          <CardContent className="p-4 sm:p-6">
            <h2 className="flex items-center gap-2 text-lg sm:text-xl font-semibold mb-3 sm:mb-4">
